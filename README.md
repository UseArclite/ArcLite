...
the contract, not the matcher, decides what a window trades against, and the crossing proof
constrains every order to a row of the table the contract committed.
